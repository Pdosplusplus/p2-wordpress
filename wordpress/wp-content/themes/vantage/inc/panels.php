...
function vantage_prebuilt_page_layouts($layouts){
	$layouts['default-home'] = array (
		...
		array(
			...
			2 =>
			array(
				'title' => __('Aprovecha el tiempo','vantage'),
			...
			3 =>
			array(
				'headline' => __('GeekOS La Solución a tus Problemast','vantage'),
				'sub_headline' => __('Y si no, lo intentamos','vantage'),
				'info' =>
				array(
			...
			array(
				'title' => '',
				'text' => __('Estas son las ultimas noticias que te trae GeekOS.','vantage'),
				'filter' => true,
				'info' =>
				array(
